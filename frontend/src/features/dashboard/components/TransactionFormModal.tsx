...
import { Alert, Button, Checkbox, Form, InputNumber, Modal, Select, Space, Typography } from "antd";
...
export function TransactionFormModal({ open, portfolio, onOk, onCancel }: Props) {
    ...
    const handleSubmit = (values: { resultValue: TransactionResultValue; amount: number; fees?: number }) => {
